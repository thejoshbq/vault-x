  ...
  return (
    <div className="mx-auto max-w-2xl animate-rise">
      ...
      <form action={completeOnboarding} className="card mt-8 grid gap-5 p-5 sm:grid-cols-2 sm:p-8">
        ...
        <label className="block sm:col-span-2"><span className="mb-1.5 block text-sm font-bold">Account name</span><input className="input" name="accountName" placeholder="Everyday checking" required /></label>
