      ...
      <section className="flex items-center justify-center px-5 py-10 sm:px-10">
        <div className="w-full max-w-md">
          <Link href="/" className="inline-flex items-center gap-2.5">
            <span className="grid size-10 place-items-center rounded-xl bg-[var(--brand)] font-black text-[var(--background)]">V</span>
            <span className="text-lg font-black">Vault X</span>
          </Link>
          {children}
        </div>
      </section>
      <section className="relative hidden overflow-hidden bg-[var(--brand)] p-12 text-[var(--background)] lg:flex lg:flex-col lg:justify-between">
        <div className="absolute -right-32 -top-24 size-[34rem] rounded-full border border-black/15" />
        <div className="absolute -right-16 -top-8 size-[26rem] rounded-full border border-black/15" />
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 border-t border-black/20 pt-7">
